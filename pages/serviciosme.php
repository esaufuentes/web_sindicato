				...
				<div class="col-sm-12 col-md-6">
					<div class="about-thumb-section">
						<div class="about-single-thumb">
							<img src="../assets/images/about/SERVICIOS MEDICOS.jpg" alt="about-img">
						</div>
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<div class="about-content-container pl-30">
						<div class="section-head-container">
							<div class="section-head">
								...
								<p style="text-align: justify;">Los servicios médicos tienen la misión de servir con 
									calidad a todas las personas que lo necesiten. </p>

								<p style="text-align: justify;">Es  importante tener en cuenta que los servrcros de salud no contemplan
									 sólo el diagnóstico y el tratamiento de enfermedades o trastornos, también abarcan
									  todo lo referente a la prevención de los males y a la difusión de aquello que ayuda </p>
							</div>
						</div>
