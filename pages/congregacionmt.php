				...
				<div class="col-sm-12 col-md-6">
					<div class="about-thumb-section">
						<div class="about-single-thumb">
							<img src="../assets/images/about/cmm.jpg" alt="about-img">
						</div>
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<div class="about-content-container pl-30">
						<div class="section-head-container">
							<div class="section-head">
								<h3>CONGREGACIÓN</h3>
								<h5>MARIANA TRINITARIA</h5>
							
							


								<span class="section-head-bar"></span>
								<p style="text-align: justify;">Trabajamos en colaboración con la Congregación Mariana Trinitaria, lo cual ha permitido 
									a familias vulnerables tener acceso a insumos como cemento, tanques de almacenamiento de aguo,
									 leche líquida, zapatos y útiles escolares. Por medio de la conformación de grupos comunitarios,
									  es como realizamos la entrega de estos beneficios, contribuyendo a potenciar el desarrollo social
									   integral en rubros que incidan en la disminución de indicadores de pobreza multidimensional.</p>
