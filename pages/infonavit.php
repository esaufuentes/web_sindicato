				...
				<div class="col-sm-12 col-md-6">
					<div class="about-thumb-section">
						<div class="about-single-thumb">
							<img src="../assets/images/about/INFONAVIT.jpg" alt="about-img">
						</div>
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<div class="about-content-container pl-30">
						<div class="section-head-container">
							<div class="section-head">
								...
								<p style="text-align: justify;" >Queremos que las familias croquistas cuenten con una vivienda digna. 
									Es por ello que nuestros asesores de vivienda apoyan con consultas gratuitas a las
									y los trabajadores para que conozcan la oferta crediticia y estén mejor informados en la toma de decisiones.</p>

								<p style="text-align: justify;">Debido a las medidas sanitarias, damos seguimiento a las consultas por teléfono, 
								redes sociales y otras plataformas de comunicación como Zoom.</p>
							</div>
						</div>
