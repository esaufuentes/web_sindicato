...
/* Estilos para pantallas de computadoras (pantallas grandes) */
...
.case-study-details:nth-child(-n+3) {
    display: block;
}
...
<body>
	...
	<div class="case-study-intro">
				<div class="csd-content">
					<div class="csd-title pb-10"><h2>Informe de Actividades 2024</h2></div>
					<iframe src="documento/INFORME_2023_V1.pdf" style="width: 100%; height: 100vh;"></iframe>
...
<!-- Tus elementos .case-study-details aquí -->

<!-- Botón para cargar más, después de tus elementos -->
