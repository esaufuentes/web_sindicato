				...
				<div class="col-sm-12 col-md-6">
					<div class="about-thumb-section">
						<div class="about-single-thumb">
							<img src="../assets/images/about/ACCIONES DE SALUD.jpg" alt="about-img">
						</div>
					</div>
				</div>
				<div class="col-sm-12 col-md-6">
					<div class="about-content-container pl-30">
						<div class="section-head-container">
							<div class="section-head">
								<h3>ACCIONES DE SALUD</h3>
							
							


								<span class="section-head-bar"></span>
								<p style="text-align: justify;">La salud es uno de los elementos más relevantes para
									 el desarrollo de una vida larga y cualitativa. Un trabajador que goza 
									 de salud, es un trabajador más productivo, capaz de desarrollarse mejor 
									 en equipo y ante la sociedad. </p>

								<p style="text-align: justify;">Por tal motivo, realizamos brigadas asistenciales en empresas, escuelas y zonas vulnerables, 
									donde se brindan servicios básicos de salud y otros relacionados a lo belleza como maquillaje, 
									aplicación de uñas de gel, planchado de cejas. </p>
							</div>
						</div>
